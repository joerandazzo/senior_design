...
package edu.siue.mech.seniordesign.ui;
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, @ColorRes int tabTitleColor) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            tabTitleView.setTextColor(ContextCompat.getColorStateList(getContext(), tabTitleColor));
        }
    }
